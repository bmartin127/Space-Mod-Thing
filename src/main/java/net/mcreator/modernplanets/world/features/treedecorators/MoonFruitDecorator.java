...
public class MoonFruitDecorator extends CocoaDecorator {
	public static final MoonFruitDecorator INSTANCE = new MoonFruitDecorator();
	public static com.mojang.serialization.Codec<MoonFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoonFruitDecorator() {
		super(0.2f);
	}
