package net.mcreator.modernplanets.world.features.treedecorators;
...
public class UranusRingsFruitDecorator extends CocoaDecorator {
	public static final UranusRingsFruitDecorator INSTANCE = new UranusRingsFruitDecorator();
	public static com.mojang.serialization.Codec<UranusRingsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("uranus_rings_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public UranusRingsFruitDecorator() {
		super(0.2f);
	}
