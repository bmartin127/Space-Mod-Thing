...
public class SpaceFruitDecorator extends CocoaDecorator {
	public static final SpaceFruitDecorator INSTANCE = new SpaceFruitDecorator();
	public static com.mojang.serialization.Codec<SpaceFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("space_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public SpaceFruitDecorator() {
		super(0.2f);
	}
