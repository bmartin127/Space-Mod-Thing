...
public class MarsBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final MarsBiomeLeaveDecorator INSTANCE = new MarsBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mars_biome_tree_leave_decorator");
