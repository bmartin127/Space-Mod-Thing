...
public class UranusRingsLeaveDecorator extends LeaveVineDecorator {
	public static final UranusRingsLeaveDecorator INSTANCE = new UranusRingsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("uranus_rings_tree_leave_decorator");
